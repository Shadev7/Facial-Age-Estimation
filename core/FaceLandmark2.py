...
'''
# testing
        input_img = cv2.imread("data/test-images/old-man.jpg")
        ...
        # we need angles between the 16 jawpoints 
        # i.e., 14 angles since 2 are endpoints
...
'''
    def detect(self, image):
        ...
        for k,d in enumerate(detections):
            ...
            face_boundary = self.calculate_face_boundary(feature_dict)
            yield FacialFeatures(ratios=ratios, feature_points=feature_dict,
                    all_points=shape, face_boundary=face_boundary)
...
#        ratios[names[4]] = self.distance_ratio(feature_dict,"left_eye",,"left_eye",,"left_eye",0,"left_eye",3)
    ...
    def calculate_face_boundary(self, feature_dict):
        pass
